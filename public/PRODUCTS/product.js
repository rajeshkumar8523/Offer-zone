...
const combos = {
  "combo-1": {
    title: "First Combo Pack",
    category: "Combo Offer",
    rating: "4.6",
    reviews: "5 Reviews",
    price: "₹3,599",
    oldPrice: "₹4,999",
    images: ["bublb.png", "heater.png", "neck.png"],
    products: [
      { name: "Charging Lite", price: "₹1,299" },
      { name: "Water Heater", price: "₹1,999" },
      { name: "Neckband Earphones", price: "₹1,699" },
    ],
  },

  "combo-2": {
    title: "Second Combo Pack",
    category: "Combo Offer",
    rating: "4.5",
    reviews: "4 Reviews",
    price: "₹2,999",
    oldPrice: "₹4,599",
    images: ["iron.png", "dosa.png", "neck.png"],
    products: [
      { name: "Iron Box", price: "₹1,699" },
      { name: "Dosa Tawa", price: "₹1,299" },
      { name: "Neckband Earphones", price: "₹1,699" },
    ],
  },
};
...
function buyNow(btn) {
  ...
  /* ---------- CATEGORY ---------- */
  const category = card.querySelector("p.text-slate-500")?.innerText || "";

  /* ---------- PRICE ---------- */
  const priceText = card.querySelector("p.text-orange-600")?.innerText || "0";
  ...
  /* ---------- RATING (FIXED) ---------- */
  const ratingText = card.querySelector(".stars span")?.innerText || "0";
  const rating = parseFloat(ratingText);

  /* ---------- DESCRIPTION ---------- */
  const description = card.querySelector("p.text-slate-600")?.innerText || "";
